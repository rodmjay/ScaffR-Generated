...
CKEDITOR.dialog.add("scaytcheck", function(j) {
    function w() { return"undefined" != typeof document.forms["optionsbar_" + a] ? document.forms["optionsbar_" + a].options : [] }
    ...
    function p(b) { for (var b = ("" + b).split(","), a = 0, e = b.length; a < e; a += 1)f.getById(b[a]).$.style.display = "inline" }

    function q(b) { for (var b = ("" + b).split(","), a = 0, e = b.length; a < e; a += 1)f.getById(b[a]).$.style.display = "none" }
    ...
    var z =
        ...
        B = {
            ...
            onShow: function() {
                ...
                if (!b.data || !b.data.scayt || !b.data.scayt_control)alert("Error loading application service"), b.hide();
                else {
                    var a = 0;
        ...
        y = function() {
            ...
            if (1 == l[0])
                for (var g = w(), e = 0, d = g.length; e < d; e++) {
                    ...
                    if (i && (g[e].checked = !1, 1 == b.options[h.split("_")[0]] && (g[e].checked = !0), s))i.on("click", function() { b.options[this.getId().split("_")[0]] = this.$.checked ? 1 : 0 })
                }
