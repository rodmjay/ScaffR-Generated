...
(function() {
    ...
    function n(a, f) {
        var l = function(e) { return new CKEDITOR.dom.element(e, a.document) }, n = a.editable(), m = a.plugins.dialogadvtab;
        return{
                                    ...
                                    children: [
                                        {
                                            ...
                                            commit: k
                                        }, { type: "text", id: "txtCols", "default": 2, label: a.lang.table.columns, required: !0, controlStyle: "width:5em", validate: o(a.lang.table.invalidCols), setup: function(e) { this.setValue(r(e)) }, commit: k }, { type: "html", html: "&nbsp;" }, {
                                            type: "select",
                                            id: "selHeaders",
                                            "default": "",
