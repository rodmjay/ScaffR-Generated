...
namespace DemoApplication.Extensions.SitemapHelpers
{
    ...
    public static class TabsExtensions
    {
        ...
        {
            {"HtmlHelper", typeof (TabsExtensions).FullName}
        };
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Tabs(this MvcSiteMapHtmlHelper helper, SiteMapNode startingNode,
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Tabs(this MvcSiteMapHtmlHelper helper, bool startFromCurrentNode,
            bool startingNodeInChildLevel, bool showStartingNode)
        {
        ...
        /// <param name="drillDownToContent">if set to <c>true</c> [drill down to content].</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Tabs(this MvcSiteMapHtmlHelper helper, int startingNodeLevel,
            ...
            bool drillDownToContent)
        {
            ...
            return Tabs(helper, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth + 1,
                drillDownToContent);
        }
        ...
        {
            return Tabs(helper, null, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth,
                drillDownToContent);
        }
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Tabs(this MvcSiteMapHtmlHelper helper, string templateName, SiteMapNode startingNode,
            bool startingNodeInChildLevel, bool showStartingNode)
        {
            return Tabs(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, Int32.MaxValue,
                false);
        }
        ...
        /// <returns>Html markup</returns>
        public static MvcHtmlString Tabs(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel,
            ...
            bool drillDownToCurrent)
        {
            ...
            return Tabs(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth + 1,
                drillDownToCurrent);
        }
        ...
        public static MvcHtmlString Tabs(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel,
            bool startingNodeInChildLevel, bool showStartingNode, int maxDepth)
        {
            return Tabs(helper, templateName, startingNodeLevel, startingNodeInChildLevel, showStartingNode, maxDepth,
                false, false);
        }
