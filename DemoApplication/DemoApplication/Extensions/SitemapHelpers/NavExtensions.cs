...
namespace DemoApplication.Extensions.SitemapHelpers
{
    ...
    public static class NavExtensions
    {
        ...
        /// Source metadata
        /// </summary>
        private static readonly Dictionary<string, object> NavSourceMetadata = new Dictionary<string, object>
        {
            {"HtmlHelper", typeof (NavExtensions).FullName}
        };
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, SiteMapNode startingNode,
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, bool startFromCurrentNode,
            bool startingNodeInChildLevel, bool showStartingNode)
        {
        ...
        /// <param name="drillDownToContent">if set to <c>true</c> [drill down to content].</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, int startingNodeLevel,
            ...
            bool drillDownToContent)
        {
            ...
            return Nav(helper, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth + 1,
                drillDownToContent);
        }
        ...
        {
            return Nav(helper, null, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth,
                drillDownToContent);
        }
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, SiteMapNode startingNode,
            bool startingNodeInChildLevel, bool showStartingNode)
        {
            return Nav(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, Int32.MaxValue,
                false);
        }
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, bool startFromCurrentNode,
            bool startingNodeInChildLevel, bool showStartingNode)
        {
            SiteMapNode startingNode = startFromCurrentNode ? GetCurrentNode(helper.Provider) : helper.Provider.RootNode;
            return Nav(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, Int32.MaxValue,
        ...
        /// <returns>Html markup</returns>
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel,
            ...
            bool drillDownToCurrent)
        {
            ...
            return Nav(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth + 1,
                drillDownToCurrent);
        }
        ...
        public static MvcHtmlString Nav(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel,
            bool startingNodeInChildLevel, bool showStartingNode, int maxDepth)
        {
            return Nav(helper, templateName, startingNodeLevel, startingNodeInChildLevel, showStartingNode, maxDepth,
                false, false);
        }
