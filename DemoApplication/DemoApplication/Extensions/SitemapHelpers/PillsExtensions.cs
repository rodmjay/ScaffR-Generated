...
namespace DemoApplication.Extensions.SitemapHelpers
{
    ...
    public static class PillsExtensions
    {
        ...
        /// Source metadata
        /// </summary>
        private static readonly Dictionary<string, object> PillsSourceMetadata = new Dictionary<string, object>
        {
            {"HtmlHelper", "Pills"}
        };
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Pills(this MvcSiteMapHtmlHelper helper, SiteMapNode startingNode,
        ...
        /// <param name="showStartingNode">Show starting node if set to <c>true</c>.</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Pills(this MvcSiteMapHtmlHelper helper, bool startFromCurrentNode,
            bool startingNodeInChildLevel, bool showStartingNode)
        {
        ...
        /// <param name="drillDownToContent">if set to <c>true</c> [drill down to content].</param>
        /// <returns>Html markup</returns>
        public static MvcHtmlString Pills(this MvcSiteMapHtmlHelper helper, int startingNodeLevel,
            ...
            bool drillDownToContent)
        {
            ...
            return Pills(helper, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth + 1,
                drillDownToContent);
        }
        ...
        {
            return Pills(helper, null, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth,
                drillDownToContent);
        }
        ...
        {
            return Pills(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, Int32.MaxValue,
                false);
        }
        ...
        /// <returns>Html markup</returns>
        public static MvcHtmlString Pills(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel,
            ...
            bool drillDownToCurrent)
        {
            ...
            return Pills(helper, templateName, startingNode, startingNodeInChildLevel, showStartingNode, maxDepth + 1,
                drillDownToCurrent);
        }
        ...
        public static MvcHtmlString Pills(this MvcSiteMapHtmlHelper helper, string templateName, int startingNodeLevel,
            bool startingNodeInChildLevel, bool showStartingNode, int maxDepth)
        {
            return Pills(helper, templateName, startingNodeLevel, startingNodeInChildLevel, showStartingNode, maxDepth,
                false, false);
        }
